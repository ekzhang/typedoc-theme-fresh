...
class FreshRenderContext extends DefaultThemeRenderContext {
  ...
  override index = () => <div style="margin-top: 64px"></div>;
    ...
    return (
      <header class="tsd-page-toolbar">
        <div class="tsd-toolbar-contents container">
          ...
          <div class="tsd-theme-toggle md-show" style="position: relative">
          ...
          >
            <svg
              ...
              style="margin-bottom: 1px; margin-left: 4px; margin-right: 4px;"
            >
              <path d="m21 21-4.34-4.34" />
              <circle cx="11" cy="11" r="8" />
            </svg>
            <span class="lg-show" style="margin-left: 4px; margin-right: 12ch;">
              Search…
            </span>
          </button>
